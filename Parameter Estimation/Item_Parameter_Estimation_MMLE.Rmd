...
We computed Thor's posterior distribution by combining a **prior** (our assumption about the population distribution of $\theta$, typically standard normal) with the **likelihood** of his response pattern:
...
## The Denominator You May Have Ignored

When we wrote Bayes' theorem for the posterior, the full expression was:
