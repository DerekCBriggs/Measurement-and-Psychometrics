...
```{r thor-likelihood, fig.height=6}
...
plot(theta_range, p1, type = "l", col = "blue", lwd = 2,
     ...
     main = "P(Item 1 Correct)", las = 1)

plot(theta_range, q2, type = "l", col = "red", lwd = 2,
     xlab = expression(theta), ylab = "Probability",
     main = "P(Item 2 Incorrect)", las = 1)

plot(theta_range, L_thor, type = "l", col = "purple", lwd = 2,
     xlab = expression(theta), ylab = "Likelihood",
     main = "Likelihood Function (1,0)", las = 1)
abline(v = theta_range[which.max(L_thor)], lty = 2)
...
plot.new()
legend("center", legend = c("P(correct)", "P(incorrect)", "Likelihood"),
       col = c("blue", "red", "purple"), lwd = 2, cex = 1.2, bty = "n")
```
...
plot(theta_range, L_storm, type = "l", col = "purple", lwd = 2,
     xlab = expression(theta), ylab = "Likelihood",
     main = "Likelihood Function for Storm (0,1)", las = 1)
mle_storm <- theta_range[which.max(L_storm)]
abline(v = mle_storm, lty = 2)
text(mle_storm + 0.5, max(L_storm) * 0.9,
     paste("MLE =", round(mle_storm, 2)))
```
...
```{r wonder-woman-likelihood}
# Likelihood for pattern (1,1)
L_ww <- p1 * p2

plot(theta_range, L_ww, type = "l", col = "purple", lwd = 2,
     xlab = expression(theta), ylab = "Likelihood",
     main = "Likelihood Function for Wonder Woman (1,1)", las = 1)
```
...
plot(theta_range, L_hulk, type = "l", col = "purple", lwd = 2,
     xlab = expression(theta), ylab = "Likelihood",
     main = "Likelihood Function for Hulk (0,0)", las = 1)
```
...
plot(theta_range, prior, type = "l", col = "blue", lwd = 2,
     xlab = expression(theta), ylab = "Density",
     main = "Prior Distribution", las = 1)

plot(theta_range, L_ww, type = "l", col = "red", lwd = 2,
     xlab = expression(theta), ylab = "Likelihood",
     main = "Likelihood (1,1)", las = 1)

plot(theta_range, posterior_ww, type = "l", col = "purple", lwd = 2,
     xlab = expression(theta), ylab = "Posterior (unnormalized)",
     main = "Posterior Distribution", las = 1)
map_ww <- theta_range[which.max(posterior_ww)]
abline(v = map_ww, lty = 2)
text(map_ww - 0.8, max(posterior_ww) * 0.9,
     paste("MAP =", round(map_ww, 2)))

plot.new()
legend("center",
       legend = c("Prior N(0,1)", "Likelihood", "Posterior"),
       col = c("blue", "red", "purple"), lwd = 2, cex = 1.2, bty = "n")
```

**Key insight**: By incorporating prior information, we now have a finite estimate for Wonder Woman! The prior distribution "pulls" the estimate back toward the population mean.
