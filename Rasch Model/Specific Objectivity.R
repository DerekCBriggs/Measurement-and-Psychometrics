...
# Example: Comparing difference logits for two different people with using
...
##Concept of trade-offs defining an interval scale

diff<-seq(from=-4,to=4, by = .5)

ldf<-data.frame(matrix(rep(0,63),nrow=7,ncol=9))
