...
knitr::opts_knit$set(root.dir = "/Users/briggsd/Library/CloudStorage/Dropbox/Github/Measurement and Psychometrics/Reliability/R Markdown Tutorial")
```
...
![CTT Sampling Visualization](CTT_Visualization.png)
...
![As More Error is Added, Correlation Decreases](Spearman.png)
...
![All loadings are the same](Essentually_tau_equivalent.png)
...
![Loadings can vary](Congeneric.png)
